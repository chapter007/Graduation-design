...
class single extends controller {
    ...
    public function getlines() {
        ...
        $num3 = array(rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70));
        $num4 = array(rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70));
        $num5 = array(rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70));
        $num6 = array(rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70));
        $num7 = array(rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70));
        $num8 = array(rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70), rand(20, 70));
        $data['total'] = $total;
        $data['num'] = $num;
        $data['num2'] = $num2;
        $data['num3'] = $num3;
