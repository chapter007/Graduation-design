...
window.message_box = (function($) {
    ...
    that.init = function(options) {
        ...
        var html='<div id="message_box_info" class="alert alert-info alert-block" style="display:none;width:300px;position:fixed;'+
        'left:0px;right:0px;margin-left:auto;margin-right:auto;top:100px;z-index:10000;" role="alert"><button type="button" class="close">&times;</button>'+
        '<span></span></div>';
        $("body").append(html);
